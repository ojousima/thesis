...
Therefore the capacitor ESR was found to be 18.2 ohms and capacitance 1.37 farads. This is well within the published initial values of ESR < 30 ohms and capacitance of 1.5 farad -20 \% ... + 80 \%, and therefore results can be considered reliable. 
...
The supercapacitor was initially fully discharged. To measure boost circuit efficiency, the storage capacitor was externally charged to 3 volts and before taking measurements. Tyre was driven at varied and speeds and loads. Power output was measured by recording stored voltage in supercapacitor before and after the test with NI 9215 \cite{ni9215}.
...
\fbox{
\begin{tabular}{l l l}
\textbf{Speed} & \textbf{Load} 		& \textbf{V_{0}} & \textbf{V_{end}} & \textbf{Duration} & \textbf{Power}	  \\ \hline
0 km / h       & 2 kN 		        & 2.989 V        & 2.978 V          & 600 s             & -75  $\mu$W       	\\ \hline
20 km / h      & 2 kN 		        & 2.674 V        & 2.676 V          & 600 s             & -34 $\mu$W       	\\ \hline
\end{tabular}
}
\end{center}
\end{table}
