...
\professorship{Automation technology \hfill Code: AS-84}
%%
...
\department{Sähkötekniikan ja automaation laitos}
\professorship{Automaatiotekniikka \hfill Koodi: AS-84}
%% Avainsanat
\keywords{Energian harvestointi, rengasanturit, aktiiviset turvajärjestelmät}
...
I would like to express my gratitude to Daniel Edwards, Lauri Jämsä, Tero Kapanen, Gaja Kochaniewicz, Martti Paalanen, Markku Rouvala and Heikki Salminen for providing insights in use cases, manufacturing methods, soundness of various ideas and textual clarity for the work.  
