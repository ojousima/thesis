...
Modern tyres have sensor systems which require energy. Currently these systems are powered by batteries, which limit the power available and lifetime of the systems. This study presents an energy harvester system to power sensor systems. Piezoelectric and electromagnetic harvester designs are 
presented and the piezoelectric harvester design was selected to use in the tyre. Electrical energy was harvested from tyre rotation and deformation, harvested power was rectified and stored into a supercapacitor at voltage level usable by modern microcontrollers. Tens of milliwatts of electrical power was obtained from both harvesters in a vibration exciter test setup, and piezoelectric harvester produced 13 microwatts of electrical power in a chassis dynamometer test rig. Further testing indicates 50 microwatts of power is obtainable at a higher speed of the tyre. The power obtained from harvester is exceeds sleep mode power requirement of sensor system, and sensor system could be theoretically operated intermittenly with power available. Continuous operation of sensor system is not feasible with the presented harvester.
\end{abstractpage}
...
Moderneissa renkaissa on anturijärjestelmiä jotka tarvitsevat energiaa. Nykyään nämä järjestelmät saavat tehonsa patteriesta, mikä 
