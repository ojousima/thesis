...
\begin{equation} \label{eq:gen_simple_power}
  P_{generated}(s) = V_{generated}(s)*I_{generated}(s),
\end{equation}
...
\begin{equation} \label{eq:gen_simple_current}
  I_{generated}(s) = \frac{V_{generated}(s)}{Z_{generator}(s)+Z_{load}(s)},
\end{equation}
...
\begin{equation}
  P_{generated}(s) = V_{generated}(s)*\frac{V_{generated}(s)}{Z_{generator}(s)+Z_{load}(s)}.
\end{equation}
