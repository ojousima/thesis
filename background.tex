...
Figures \ref{80_TD} and \ref{80_TD_zoom} are time domain representations of the acceleration along 3 axes as shown in figure \ref{tyre_axes}{\color{red}Lis\"a\"a kuva jossa akselien suunnat}. First figure shows 10 rotations of tyre, contact with drum is clearly visible as a sudden shock. Second figure is a zoom into one rotation.
...
\end{center}
\caption{Axis in measurement by Matilainen et al \cite{Matilainen2012}}
\label{80_TD}
\end{figure}
