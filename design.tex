...
Number of turns per pole	& Higher voltage	& Smaller size 		\\ \hline
Number of poles			& Increased frequency	& Decreased frequency	\\ \hline
Distance between poles  	& More space for wiring & Higher voltage	\\ \hline
Wiring radius		  	& 0.9 $\mu A$ 		& 275 $\mu A$ 		\\ \hline
Magnetic field strength  	& 0.9 $\mu A$ 		& 275 $\mu A$ 		\\ \hline
Wire diameter		  	& 0.9 $\mu A$ 		& 275 $\mu A$ 		\\ \hline
\end{tabular}
}
\end{center}
\end{table}
