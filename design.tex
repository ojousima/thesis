...
N_{turns}                     & Higher voltage		& Smaller size, less wiring resistance 		\\ \hline
N_{pole}		      & Increased frequency		& Decreased frequency	\\ \hline
l_{pole}                      & More space for wiring 	& Higher voltage, smaller size	\\ \hline
A_{loop}		      & More power			& Smaller length of wiring 	\\ \hline
B                             & Increased power 	        & Smaller magnets 		\\ \hline
r_{wire}		      & Decreased wiring resistance 	& More turns in same space 	\\ \hline
...
\begin{figure}
    ...
    \caption{\label{fig:bluetooth_circuit} Bluetooth connectivity built around BLE113}
\end{figure}
...
\begin{figure}
    \centering
    \def\svgwidth{\columnwidth}
    \input{images/own_dwg/circuit/pcb_render.pdf_tex}
